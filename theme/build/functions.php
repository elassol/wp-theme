<?php
/**
 * lassodesigns functions and definitions.
 *
...
if ( ! function_exists( 'lassodesigns_setup' ) ) :
/**
...
function lassodesigns_setup() {
	 ...
	 * If you're building a theme based on lassodesigns, use a find and replace
	 * to change 'lassodesigns' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'lassodesigns', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'lassodesigns' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'lassodesigns_custom_background_args', array(
 ...
 */
function lassodesigns_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'lassodesigns_content_width', 640 );
}
add_action( 'after_setup_theme', 'lassodesigns_content_width', 0 );
 ...
 */
function lassodesigns_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'lassodesigns' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'lassodesigns' ),
...
add_action( 'widgets_init', 'lassodesigns_widgets_init' );
